...
from .serializers import ProductSerializer,AttendanceTableSerializer
...
class UpdateAttendances(APIView):
    def post(self, request):
...
class AttendanceList(APIView):
    def get(self, request):
        products = AttendanceTable.objects.all()
        serializer = AttendanceTableSerializer(products, many=True)
        return Response(serializer.data)
